...
generateSimulatedPopulationAnalysisData <- function(
    ...
    checkmate::assertNumeric(riskWindowAfterTargetExposureDays, lower = 1)
    checkmate::assertNumeric(washoutPeriodDays, lower = 1)
    checkmate::assertList(highRiskGroupDefinition)
    checkmate::assertChoice(matchHighRiskCriteria, choices = c('any', 'all'))
    checkmate::assertNumeric(lowRiskComparatorIncidence, lower = 0, upper = 1)
    checkmate::assertNumeric(lowRiskTargetIncidence, lower = 0, upper = 1)
    checkmate::assertNumeric(highRiskComparatorIncidence, lower = 0, upper = 1)
...
#' `studyEndDate.`
#'
#' @param cohort            A tibble containing the cohort table generated by the `generateSimulatedCohortTable` function.
#' @param matchedCohort     A tibble containing the matched cohort table generated by the `generateMatchedCohort` function.
...
#' @param comparatorCohort  A comparator cohort tibble generated by `generateComparatorCohortFromSimulatedTargetCohortTable` function.
...
#'                   a comparator cohort tibble generated by `generateComparatorCohortFromSimulatedTargetCohortTable` function.
...
#'
#' @param targetCohort                       A tibble generated by the `generateTargetCohortFromSimulatedCohortTable` function.
#' @param riskWindowAfterTargetExposureDays  The number of days after the target exposure to include in the risk window.
...
#'
#' @param targetCohort                      A tibble generated by the `getLatestCohortEntryFromEachPersonInTargetCohort` function.
...
#'
#'
#' @param comparatorCohort                  A tibble generated by the `getLatestCohortEntryFromEachPersonInTargetCohort` function.
#' @param includePersonIds                  A vector of person IDs to include in the outcomes cohort. If empty, all persons in the
...
#'
#'
#' @param persons                                   A tibble with a format similar to the `persons` table in an OHDSI CDM instance.
#'                                                  The tibble must include the following columns: `person_id`, `birth_datetime`,
