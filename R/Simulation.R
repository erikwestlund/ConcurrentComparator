...
#' @param riskWindowAfterTargetExposureDays     The number of days in the washout period.
#'
#' @return
#' A tibble with the following columns:
  ...
  riskWindowAfterTargetExposureDays = 21
    ...
    cohort %>%
        mutate(
            ...
            observation_period_end_date = cohort_start_date  + riskWindowAfterTargetExposureDays
        ) %>%
